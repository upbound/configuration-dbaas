...
uptest: $(UPTEST) $(KUBECTL) $(KUTTL)
	...
	@KUBECTL=$(KUBECTL) KUTTL=$(KUTTL) $(UPTEST) e2e examples/postgres-azure-claim.yaml,examples/mariadb-azure-claim.yaml --setup-script=test/setup.sh --default-timeout=2400 || $(FAIL)
